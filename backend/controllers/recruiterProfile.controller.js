...
export const submitRecruiterProfile = asyncHandler(async (req,res) => {
    const { user_id ,fullname , phone , address , designation , linkedInProfile , expertiseAreas , totalExperience ,bio , preferredInterviewType } = req.body;

    if(!user_id || !fullname || !phone || !address || !designation || !expertiseAreas ) {
    ...
    .json(new ApiResponse(201, "Recruiter profile created successfully", {createdProfile , newUpdatedUser}))
