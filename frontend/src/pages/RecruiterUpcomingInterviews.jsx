        ...
        <div className="flex flex-col space-y-4">
          <div>
            ...
            <p className="text-gray-600 mt-1 text-sm md:text-base">
              Manage and conduct interviews assigned to you
            </p>
          </div>
            ...
            <Card className="border-l-4 border-l-[#6A38C2]">
              <CardContent className="p-4">
                <div className="flex items-center space-x-3">
                  <Users className="h-5 w-5 text-[#6A38C2] flex-shrink-0" />
                  ...
                  <div className="p-4 space-y-4">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                        <Avatar className="h-10 w-10">
                          <AvatarImage src={interview.candidateSelected?.profilePhoto} />
                          <AvatarFallback className="bg-[#6A38C2] text-white">
                            {interview.candidateSelected?.username?.charAt(0)?.toUpperCase() || 'C'}
                          </AvatarFallback>
                        </Avatar>
                        <div className="min-w-0 flex-1">
                          ...
                          <div className="flex items-center space-x-2 mt-1">
                            ...
                            <span className="text-xs text-gray-500 truncate">
                              {interview.candidateSelected?.email || 'No email'}
                            </span>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="pt-3 border-t border-gray-100 space-y-2">
                      ...
                      >
                        ...
                        {interview.status === 'scheduled' ? (
                          isInterviewLive(interview.scheduledAt) ? 'Start Interview' : 'Start Interview'
